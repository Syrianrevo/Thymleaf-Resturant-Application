...
import com.syrianrevo.thymeleafkafkaproject.web.EntryController;
...
public class EntryControllerTest {
    ...
    public void addEntry() throws Exception {
        String newEntry = json(new Entry("blah", "blah blah blah", "blah", "blah blah blah","asdasd"));
    ...
    public void updateEntry() throws Exception {
        String entryUpdate = json(new Entry("blah", "blah blah blah", "blah", "blah blah blah", "blah"));
